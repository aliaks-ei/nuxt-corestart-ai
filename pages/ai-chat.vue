      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300">
            Chat with OpenAI's GPT model. Ask questions, get creative, or just have a conversation!
          </p>
        </div>
        ...
        <UCard class="mb-6">
          ...
          <div v-show="showSettings" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                />
                <p class="text-xs text-gray-500 mt-1">
                  {{ streamMode ? 'Real-time response' : 'Wait for complete response' }}
                </p>
              </div>
            </div>
          </div>
          ...
          <UCard v-if="messages.length > 0" class="min-h-[300px]">
            ...
            <div class="space-y-4 max-h-[500px] overflow-y-auto">
              ...
              <div v-if="streamingResponse" class="flex justify-start">
                <div class="max-w-[80%] rounded-lg px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white">
                  <div class="text-xs opacity-70 mb-1">AI Assistant</div>
                  <div class="whitespace-pre-wrap">{{ streamingResponse }}</div>
                  <div v-if="isStreaming" class="inline-block w-2 h-4 bg-current animate-pulse ml-1"></div>
                </div>
              </div>
            </div>
          </UCard>
